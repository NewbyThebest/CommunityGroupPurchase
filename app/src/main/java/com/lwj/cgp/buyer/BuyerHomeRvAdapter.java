...
public class BuyerHomeRvAdapter extends RecyclerView.Adapter<BuyerHomeRvAdapter.MyHolder> {

    private List<GoodsData> mList;
    private OnItemClickListener mOnItemClickListener;

    public BuyerHomeRvAdapter(List<GoodsData> list) {
        mList = list;
    }
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        holder.seller.setText(data.seller);
